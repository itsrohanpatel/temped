...
{ highlight: /\bearn per year\b/gi, keyword: "Earn per year", category: "money" },
...
{ highlight: /\b100% guaranteed\b/gi, keyword: "100% guaranteed", category: "overpromise" },
...
{ highlight: /\bamazing deal\b/gi, keyword: "Amazing deal", category: "overpromise" },
...
{ highlight: /\bbig profit\b/gi, keyword: "Big profit", category: "overpromise" },
{ highlight: /\bbonus\b/gi, keyword: "Bonus", category: "overpromise" },
{ highlight: /\bboss\b/gi, keyword: "Boss", category: "overpromise" },
{ highlight: /\bcan’t miss\b/gi, keyword: "Can’t miss", category: "overpromise" },
...
{ highlight: /\bdouble your money\b/gi, keyword: "Double your money", category: "overpromise" },
...
{ highlight: /\bfor just\b/gi, keyword: "For just", category: "overpromise" },
{ highlight: /\bfree access\b/gi, keyword: "Free access", category: "overpromise" },
{ highlight: /\bfree antivirus\b/gi, keyword: "Free antivirus", category: "overpromise" },
...
{ highlight: /\bguaranteed results\b/gi, keyword: "Guaranteed results", category: "overpromise" },
...
{ highlight: /\binstant savings\b/gi, keyword: "Instant savings", category: "overpromise" },
...
{ highlight: /\bjoin millions of americans\b/gi, keyword: "Join millions of Americans", category: "overpromise" },
...
{ highlight: /\bmoney-back guarantee\b/gi, keyword: "Money-back guarantee", category: "overpromise" },
...
{ highlight: /\bone hundred percent free\b/gi, keyword: "One hundred percent free", category: "overpromise" },
{ highlight: /\bone hundred percent guaranteed\b/gi, keyword: "One hundred percent guaranteed", category: "overpromise" },
...
{ highlight: /\bwill not believe\b/gi, keyword: "Will not believe", category: "overpromise" },
{ highlight: /\bwonderful\b/gi, keyword: "Wonderful", category: "overpromise" },
{ highlight: /\byou will not believe your eyes\b/gi, keyword: "You will not believe your eyes", category: "overpromise" },
{ highlight: /\b100% natural\b/gi, keyword: "100% natural", category: "shady" },
{ highlight: /\b0 down\b/gi, keyword: "0 down", category: "shady" },
{ highlight: /\baccount update\b/gi, keyword: "Account update", category: "shady" },
{ highlight: /\baccess your account\b/gi, keyword: "Access your account", category: "shady" },
{ highlight: /\badult content\b/gi, keyword: "Adult content", category: "shady" },
...
{ highlight: /\bantivirus\b/gi, keyword: "Antivirus", category: "shady" },
...
{ highlight: /\bbet now\b/gi, keyword: "Bet now", category: "shady" },
{ highlight: /\bbig win\b/gi, keyword: "Big win", category: "shady" },
{ highlight: /\bbill 1618\b/gi, keyword: "Bill 1618", category: "shady" },
{ highlight: /\bblackjack\b/gi, keyword: "Blackjack", category: "shady" },
...
{ highlight: /\bcasino bonus\b/gi, keyword: "Casino bonus", category: "shady" },
{ highlight: /\bcash out now\b/gi, keyword: "Cash out now", category: "shady" },
...
{ highlight: /\bcertified organic\b/gi, keyword: "Certified organic", category: "shady" },
{ highlight: /\bchance\b/gi, keyword: "Chance", category: "shady" },
{ highlight: /\bchange password\b/gi, keyword: "Change password", category: "shady" },
...
{ highlight: /\bclaims not to be selling anything\b/gi, keyword: "Claims not to be selling anything", category: "shady" },
{ highlight: /\bclaims to be in accordance with some spam law\b/gi, keyword: "Claims to be in accordance with some spam law", category: "shady" },
...
{ highlight: /\bclick to verify\b/gi, keyword: "Click to verify", category: "shady" },
{ highlight: /\bclick to win\b/gi, keyword: "Click to win", category: "shady" },
{ highlight: /\bclinical trial\b/gi, keyword: "Clinical trial", category: "shady" },
...
{ highlight: /\bconfidential information\b/gi, keyword: "Confidential information", category: "shady" },
{ highlight: /\bconfidentiality\b/gi, keyword: "Confidentiality", category: "shady" },
{ highlight: /\bconfirm your details\b/gi, keyword: "Confirm your details", category: "shady" },
...
{ highlight: /\bcure for\b/gi, keyword: "Cure for", category: "shady" },
{ highlight: /\bcures\b/gi, keyword: "Cures", category: "shady" },
{ highlight: /\bcures baldness\b/gi, keyword: "Cures baldness", category: "shady" },
{ highlight: /\bcyber monday\b/gi, keyword: "Cyber Monday", category: "shady" },
{ highlight: /\bdata breach\b/gi, keyword: "Data breach", category: "shady" },
...
{ highlight: /\bdiet pill\b/gi, keyword: "Diet pill", category: "shady" },
...
{ highlight: /\bdoctor recommended\b/gi, keyword: "Doctor recommended", category: "shady" },
{ highlight: /\bdouble blind study\b/gi, keyword: "Double blind study", category: "shady" },
{ highlight: /\beliminate debt\b/gi, keyword: "Eliminate debt", category: "shady" },
{ highlight: /\bexclusive access\b/gi, keyword: "Exclusive access", category: "shady" },
...
{ highlight: /\bfat burner\b/gi, keyword: "Fat burner", category: "shady" },
...
{ highlight: /\bfree chips\b/gi, keyword: "Free chips", category: "shady" },
...
{ highlight: /\bfree spins\b/gi, keyword: "Free spins", category: "shady" },
{ highlight: /\bfree website\b/gi, keyword: "Free website", category: "shady" },
{ highlight: /\bfree!\b/gi, keyword: "Free!", category: "shady" },
{ highlight: /\bgamble online\b/gi, keyword: "Gamble online", category: "shady" },
{ highlight: /\bget\b/gi, keyword: "Get", category: "shady" },
{ highlight: /\bget slim\b/gi, keyword: "Get slim", category: "shady" },
...
{ highlight: /\bgreat news\b/gi, keyword: "Great news", category: "shady" },
...
{ highlight: /\bguaranteed weight loss\b/gi, keyword: "Guaranteed weight loss", category: "shady" },
{ highlight: /\bhair growth\b/gi, keyword: "Hair growth", category: "shady" },
{ highlight: /\bhave you been turned down\?\b/gi, keyword: "Have you been turned down?", category: "shady" },
{ highlight: /\bhello (with no name included)\b/gi, keyword: "Hello (with no name included)", category: "shady" },
...
{ highlight: /\bhot deal\b/gi, keyword: "Hot deal", category: "shady" },
...
{ highlight: /\bimportant update\b/gi, keyword: "Important update", category: "shady" },
{ highlight: /\bimprove security\b/gi, keyword: "Improve security", category: "shady" },
{ highlight: /\binstant weight loss\b/gi, keyword: "Instant weight loss", category: "shady" },
{ highlight: /\binstant winnings\b/gi, keyword: "Instant winnings", category: "shady" },
...
{ highlight: /\bjackpot\b/gi, keyword: "Jackpot", category: "shady" },
...
{ highlight: /\blive dealer\b/gi, keyword: "Live dealer", category: "shady" },
...
{ highlight: /\blottery winner\b/gi, keyword: "Lottery winner", category: "shady" },
...
{ highlight: /\blucky chance\b/gi, keyword: "Lucky chance", category: "shady" },
...
{ highlight: /\bmedical breakthrough\b/gi, keyword: "Medical breakthrough", category: "shady" },
...
{ highlight: /\bmiracle cure\b/gi, keyword: "Miracle cure", category: "shady" },
...
{ highlight: /\bnatural remedy\b/gi, keyword: "Natural remedy", category: "shady" },
...
{ highlight: /\bnew login detected\b/gi, keyword: "New login detected", category: "shady" },
...
{ highlight: /\bno hidden Ñ osts\b/gi, keyword: "No hidden Ñ osts", category: "shady" },
...
{ highlight: /\bno prescription needed\b/gi, keyword: "No prescription needed", category: "shady" },
...
{ highlight: /\bonline account\b/gi, keyword: "Online account", category: "shady" },
{ highlight: /\bonline betting\b/gi, keyword: "Online betting", category: "shady" },
{ highlight: /\bonline biz opportunity\b/gi, keyword: "Online biz opportunity", category: "shady" },
{ highlight: /\bonline casino\b/gi, keyword: "Online casino", category: "shady" },
{ highlight: /\bonline degree\b/gi, keyword: "Online degree", category: "shady" },
{ highlight: /\bonline gaming\b/gi, keyword: "Online gaming", category: "shady" },
...
{ highlight: /\bover-the-counter\b/gi, keyword: "Over-the-counter", category: "shady" },
{ highlight: /\bpain relief\b/gi, keyword: "Pain relief", category: "shady" },
{ highlight: /\bpassword\b/gi, keyword: "Password", category: "shady" },
{ highlight: /\bpassword reset\b/gi, keyword: "Password reset", category: "shady" },
...
{ highlight: /\bpayment details needed\b/gi, keyword: "Payment details needed", category: "shady" },
...
{ highlight: /\bphishing alert\b/gi, keyword: "Phishing alert", category: "shady" },
...
{ highlight: /\bpoker tournament\b/gi, keyword: "Poker tournament", category: "shady" },
{ highlight: /\bpresently\b/gi, keyword: "Presently", category: "shady" },
{ highlight: /\bprescription drugs\b/gi, keyword: "Prescription drugs", category: "shady" },
...
{ highlight: /\breverse age\b/gi, keyword: "Reverse age", category: "shady" },
{ highlight: /\breverse aging\b/gi, keyword: "Reverse aging", category: "shady" },
...
{ highlight: /\brisk-free bet\b/gi, keyword: "Risk-free bet", category: "shady" },
...
{ highlight: /\bsafe and effective\b/gi, keyword: "Safe and effective", category: "shady" },
...
{ highlight: /\bscientifically proven\b/gi, keyword: "Scientifically proven", category: "shady" },
...
{ highlight: /\bsecret formula\b/gi, keyword: "Secret formula", category: "shady" },
{ highlight: /\bsection 301\b/gi, keyword: "Section 301", category: "shady" },
{ highlight: /\bsecure payment\b/gi, keyword: "Secure payment", category: "shady" },
{ highlight: /\bsecurity breach\b/gi, keyword: "Security breach", category: "shady" },
{ highlight: /\bsecurity update\b/gi, keyword: "Security update", category: "shady" },
...
{ highlight: /\bslots jackpot\b/gi, keyword: "Slots jackpot", category: "shady" },
...
{ highlight: /\bspecial invitation\b/gi, keyword: "Special invitation", category: "shady" },
{ highlight: /\bspecial offer\b/gi, keyword: "Special offer", category: "shady" },
{ highlight: /\bspin to win\b/gi, keyword: "Spin to win", category: "shady" },
...
{ highlight: /\bthe email asks for a credit card\b/gi, keyword: "The email asks for a credit card", category: "shady" },
{ highlight: /\bthe following form\b/gi, keyword: "The following form", category: "shady" },
{ highlight: /\bthey make a claim or claims that they're in accordance with spam law\b/gi, keyword: "They make a claim or claims that they're in accordance with spam law", category: "shady" },
{ highlight: /\bthey try to keep your money no refund\b/gi, keyword: "They try to keep your money no refund", category: "shady" },
...
{ highlight: /\btry for free\b/gi, keyword: "Try for free", category: "shady" },
...
{ highlight: /\bupdate account\b/gi, keyword: "Update account", category: "shady" },
...
{ highlight: /\bverify identity\b/gi, keyword: "Verify identity", category: "shady" },
...
{ highlight: /\bvip offer\b/gi, keyword: "VIP offer", category: "shady" },
...
{ highlight: /\bwarning message\b/gi, keyword: "Warning message", category: "shady" },
...
{ highlight: /\bwinner announced\b/gi, keyword: "Winner announced", category: "shady" },
{ highlight: /\bwinning\b/gi, keyword: "Winning", category: "shady" },
{ highlight: /\bwinning numbers\b/gi, keyword: "Winning numbers", category: "shady" },
...
{ highlight: /\byouthful skin\b/gi, keyword: "Youthful skin", category: "shady" },
...
{ highlight: /\baccount-based marketing (abm)\b/gi, keyword: "Account-based marketing (ABM)", category: "unnatural" },
...
{ highlight: /\bconfidentiality on all orders\b/gi, keyword: "Confidentiality on all orders", category: "unnatural" },
{ highlight: /\bconfidentially on all orders\b/gi, keyword: "Confidentially on all orders", category: "unnatural" },
...
{ highlight: /\bdear(est)? (email|friend|somebody)\b/gi, keyword: "Dear [email/friend/somebody]", category: "unnatural" },
...
{ highlight: /\bif you no longer wish to receive\b/gi, keyword: "If you no longer wish to receive", category: "unnatural" },
{ highlight: /\bimportant information regarding\b/gi, keyword: "Important information regarding", category: "unnatural" },
...
{ highlight: /\bact fast\b/gi, keyword: "Act fast", category: "urgency" },
...
{ highlight: /\bactivate now\b/gi, keyword: "Activate now", category: "urgency" },
...
{ highlight: /\bcall now!\b/gi, keyword: "Call now!", category: "urgency" },
{ highlight: /\bcan we have a minute of your time\?\b/gi, keyword: "Can we have a minute of your time?", category: "urgency" },
...
{ highlight: /\bdownload now\b/gi, keyword: "Download now", category: "urgency" },
...
{ highlight: /\bimmediate action required\b/gi, keyword: "Immediate action required", category: "urgency" },
...
{ highlight: /\binstall now\b/gi, keyword: "Install now", category: "urgency" },
{ highlight: /\binstant\b/gi, keyword: "Instant", category: "urgency" },
{ highlight: /\blast warning\b/gi, keyword: "Last warning", category: "urgency" },
{ highlight: /\blimited time\b/gi, keyword: "Limited time", category: "urgency" },
{ highlight: /\blog in now\b/gi, keyword: "Log in now", category: "urgency" },
{ highlight: /\bmust read\b/gi, keyword: "Must read", category: "urgency" },
...
{ highlight: /\bonly available here\b/gi, keyword: "Only available here", category: "urgency" },
